...
class Room(TimeStampedModel):
    relation = models.ForeignKey(get_user_model(), on_delete=models.DO_NOTHING, verbose_name="관계자",
                                 related_name="relate")
    relation2 = models.ForeignKey(get_user_model(), on_delete=models.DO_NOTHING, verbose_name="관계자2",
                                  related_name="relate2")

    tagset = models.ForeignKey("accounts.TagSet", on_delete=models.DO_NOTHING, verbose_name="태그셋1",
                               related_name="room_tagset")
    tagset2 = models.ForeignKey("accounts.TagSet", on_delete=models.DO_NOTHING, verbose_name="태그셋2",
                                related_name="room_tagset2")
...
class Message(TimeStampedModel):
    ...
    sender = models.ForeignKey(get_user_model(), on_delete=models.DO_NOTHING, verbose_name="전송자",
                               related_name="room_sender")
    receiver = models.ForeignKey(get_user_model(), on_delete=models.DO_NOTHING, verbose_name="수신자",
